...
function takeSnapshot() {
  ...
  context = canvas.getContext('2d').drawImage(video, 0, 0, width, height);

  img.src = canvas.toDataURL("image/png");

  screenshotsContainer.prepend(img);
  document.getElementById("foto").value=img.src;
  
  document.getElementById('vid_container').innerHTML='<center>AGUARDE...</center>';    
  document.getElementById('etapa1').submit();
